...
public class Client {  
    ...
    public boolean login() {  
	        HttpGet getLoginPage = new HttpGet("http://jf.ccb.com/exchangecenter/login/showLogin.jhtml");//教务处登陆页面get  
	...
	//            HttpPost post = new HttpPost("");//构建post对象  
    ...
    void getVerifyingCode(HttpClient client) {  
        HttpPost getVerifyCode = new HttpPost("http://jf.ccb.com/exchangecenter/login/checkRandomCodeForAjax.jhtml?p="+new Date().getTime());//验证码get  
